...
import top.intkilow.feat.qrscan.core.ResultPoint;
...
public final class ViewfinderView extends View {
    ...
    public void setColor(int cornerColor, int laserColor, int resultPointColor) {
    ...
    private void drawCorner(Canvas canvas, Rect frame) {
        ...
        //左上
        canvas.drawRect(frame.left - x, frame.top - x, frame.left + cornerRectWidth - x, frame.top + cornerRectHeight - x, paint);//Y
        canvas.drawRect(frame.left - x, frame.top - x, frame.left + cornerRectHeight - x, frame.top + cornerRectWidth - x, paint);//X


        //右上
        canvas.drawRect(frame.right - cornerRectWidth + x, frame.top - x, frame.right + x, frame.top + cornerRectHeight - x, paint);
        canvas.drawRect(frame.right - cornerRectHeight + x, frame.top - x, frame.right + x, frame.top + cornerRectWidth - x, paint);


        //左下
        canvas.drawRect(frame.left - x, frame.bottom - cornerRectWidth + x, frame.left + cornerRectHeight - x, frame.bottom + x, paint);
        canvas.drawRect(frame.left - x, frame.bottom - cornerRectHeight + x, frame.left + cornerRectWidth - x, frame.bottom + x, paint);


        //右下
        canvas.drawRect(frame.right - cornerRectWidth + x, frame.bottom - cornerRectHeight + x, frame.right + x, frame.bottom + x, paint);
        canvas.drawRect(frame.right - cornerRectHeight + x, frame.bottom - cornerRectWidth + x, frame.right + x, frame.bottom + x, paint);
    }
