package top.intkilow.feat.qrscan.core;
/*
...
public final class Intents {
    ...
    public static final class Scan {
         ...
         * the results.
         */
        public static final String ACTION = "top.antaikeji.feat.qrscan.core.client.android.SCAN";
         ...
         * {@link top.intkilow.feat.qrscan.core.BarcodeFormat}s, e.g. {@link top.intkilow.feat.qrscan.core.BarcodeFormat#EAN_13}.
        ...
        /**
         * @see top.intkilow.feat.qrscan.core.DecodeHintType#CHARACTER_SET
         */
         ...
         * See {@link top.intkilow.feat.qrscan.core.BarcodeFormat} for possible values.
         */
         ...
         * to {@link top.intkilow.feat.qrscan.core.BarcodeFormat#UPC_A} and {@link top.intkilow.feat.qrscan.core.BarcodeFormat#EAN_13}
         * formats.
         */
        ...
        /**
         * Key for the value of {@link top.intkilow.feat.qrscan.core.ResultMetadataType#ORIENTATION}, if available.
         * Call {@link Intent#getIntArrayExtra(String)} with {@code RESULT_ORIENTATION}.
         */
        public static final String RESULT_ORIENTATION = "SCAN_RESULT_ORIENTATION";

        /**
         * Key for the value of {@link top.intkilow.feat.qrscan.core.ResultMetadataType#ERROR_CORRECTION_LEVEL}, if available.
         * Call {@link Intent#getStringExtra(String)} with {@code RESULT_ERROR_CORRECTION_LEVEL}.
         */
        public static final String RESULT_ERROR_CORRECTION_LEVEL = "SCAN_RESULT_ERROR_CORRECTION_LEVEL";

        /**
         * Prefix for keys that map to the values of {@link top.intkilow.feat.qrscan.core.ResultMetadataType#BYTE_SEGMENTS},
    ...
    public static final class Encode {
         ...
         */
        public static final String ACTION = "top.antaikeji.feat.qrscan.core.client.android.ENCODE";
         ...
         * format is one of {@link top.intkilow.feat.qrscan.core.BarcodeFormat}.
         */
    ...
    public static final class SearchBookContents {
         ...
         */
        public static final String ACTION = "top.antaikeji.feat.qrscan.core.client.android.SEARCH_BOOK_CONTENTS";
    ...
    public static final class WifiConnect {
         ...
         */
        public static final String ACTION = "top.antaikeji.feat.qrscan.core.client.android.WIFI_CONNECT";
    ...
    public static final class Share {
         ...
         */
        public static final String ACTION = "top.antaikeji.feat.qrscan.core.client.android.SHARE";
